...
> Generated by the `to-prd` skill. Vocabulary follows [`docs/glossary.md`](../glossary.md); all
> decisions respect the 12 ADRs in [`docs/adr/`](../adr/). Where this PRD and an ADR disagree,
> the ADR wins.
